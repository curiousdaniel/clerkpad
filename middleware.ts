...
export const config = {
  matcher: [
    ...
    "/",
    "/((?!login|register|forgot-password|reset-password|feedback|user-agreement|privacy-policy|api/auth|api/register|api/feedback|api/invite|api/sync|api/cron|_next/static|_next/image|favicon.ico|manifest.json|offline.html|sw.js|icons|workbox).*)",
  ],
};
